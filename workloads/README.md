# Task bundles (workloads)

A task bundle, called a workload in this repository, combines agent
instructions and the OpenShell inputs for a defined operation. It keeps the
